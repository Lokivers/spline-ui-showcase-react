...
export function GetInTouchSection() {
  ...
  return <section id="get-in-touch" className="py-12 md:py-20 relative min-h-screen bg-black/[0.99]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ContainerScroll titleComponent={<div className="mb-8 md:mb-12">
          ...
          <div className="flex flex-col items-center justify-center h-full p-4 md:p-8 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 rounded-lg">
            <div className="text-center space-y-6 md:space-y-8 max-w-2xl">
              ...
              <div className="space-y-3 md:space-y-4 text-white hidden lg:block">
                <motion.div className="flex items-center justify-center space-x-3 text-base md:text-lg" whileHover={{
                scale: 1.05
              }} transition={{
                duration: 0.2
              }}>
              ...
              <div className="pt-4 md:pt-6">
                ...
                scale: 0.95
                  ...
                  <Button onClick={scrollToContact} className="relative bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold transition-all duration-300 transform group text-white border-0 overflow-hidden">
