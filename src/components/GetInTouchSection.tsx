...
export function GetInTouchSection() {
  ...
  return (
<<<<<<< HEAD
    <section id="get-in-touch" className="pt-2 md:pt-4 pb-12 md:pb-20 relative min-h-screen bg-black/[0.99]">
=======
    <section id="get-in-touch" className="relative min-h-screen bg-black/[0.99]">
